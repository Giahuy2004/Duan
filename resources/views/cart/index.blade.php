        ...
        <div class="row">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic" style="width: 100px; height: 100px;">
                                            <img src="{{ $item->product->images }}" alt="{{ $item->product->name }}" style="width: 100%; height: 100%;" />
                                        </div>
                                    ...
                                    <td class="quantity__item">
                                        <div class="quantity">
                                            <div class="pro-qty-2">
                                                <input type="text" value="{{ $item->product_quantity }}" disabled>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="cart__price">{{ number_format($item->product->price * $item->product_quantity, 0, ',', '.') }} vnđ</td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="continue__btn update__btn">
                            <a href="{{ route('cart.index') }}"><i class="fa fa-spinner"></i> Update cart</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="cart__total">
                    ...
                    <ul>
                        @php
                        $subtotal = optional($cart)->products->sum(function ($item) {
                        return $item->product->price * $item->product_quantity;
                        });
                        @endphp
                        <li>Subtotal <span>{{ number_format($subtotal ?? 0, 0, ',', '.') }} vnđ</span></li>
                        <li>Total <span>{{ number_format($subtotal ?? 0, 0, ',', '.') }} vnđ</span></li>
                    </ul>
                    <div class="cart">
                        @if ($cart && $cart->products->isNotEmpty())
                            <a href="{{ route('checkout.form') }}" class="primary-btn">Checkout</a>
                        @else
                            ...
                            <table class="table-shopping-cart">
                                ...
                                @if ($cart && $cart->products->isNotEmpty())
                                    ...
                                    <tr class="table_row">
                                        <td class="column-1">
                                            <div class="how-itemcart1">
                                                <img src="{{ $item->product->images ? asset($item->product->images) : asset('img/default-product.png') }}" alt="{{ $item->product->name }}">
                                            </div>
                                        </td>
                                        ...
                                        <td class="column-4">
                                            <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                ...
                                                <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product[]" value="{{ $item->product_quantity }}" min="1" disabled>
                                                <div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
                                                    <i class="fs-16 zmdi zmdi-plus"></i>
                                                </div>
                                            </div>
                    ...
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="flex-w flex-t bor12 p-b-13">
                            ...
                            <div class="size-209">
                                ...
                                @endphp
                                <span class="mtext-110 cl2">{{ number_format($subtotal ?? 0, 0, ',', '.') }} vnđ</span>
                            </div>
                        </div>
